...
author: 
  - Aleksandra Duda, Jagoda Głowacka-Walas^[Tranistion Technologies Science]
date: "`r Sys.Date()`"
output:
  html_vignette:
    toc: yes
vignette: >
  %\VignetteIndexEntry{Comparison of Minimization Randomization with Other Randomization Methods. Assessing the balance of covariates.}
